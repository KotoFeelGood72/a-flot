<template>
    <NuxtLayout class="section-hero section-hero-post section-top-vabout">
        ...
        <div class="container">
          <div class="vabout-top-block">
           ...
           <div class="vabout-pag">
            ...
            <!-- /.vabout-pag-link -->
            <a href="#" class="vabout-pag-link">Chief Engineer (Старший механик)</a>
            <!-- /.vabout-pag-link -->
        </div>
           <!-- /.vabout-pag -->
          </div>
...
<section class="section-vabout">
  <div class="container">
   ...
   <!-- /.vabout-title -->
    ...
    <div class="news-info">
      <div class="news-date vabout-date">13 декабря 2023</div>
      <!-- /.news-date -->
      ...
      <div class="vabout-block">
            ...
            <div class="vabout-part">
                ...
                <div class="vabout-info">
                    <div class="vabout-item">
                        ...
                        <!-- /.vabout-subtitle -->
                        <strong class="vabout-subtext">2000 - 2300 USD</strong>
                        <!-- /.vabout-subtext -->
                    </div>
                    <!-- /.vabout-item -->
                    <div class="vabout-item">
                        ...
                        <!-- /.vabout-subtitle -->
                        <div class="vabout-subtext">6 месяцев</div>
                        <!-- /.vabout-subtext -->
                    </div>
                    <!-- /.vabout-item -->
                    <div class="vabout-item">
                        ...
                        <!-- /.vabout-subtitle -->
                        <div class="vabout-subtext">22.01 - 31.01.2024</div>
                        <!-- /.vabout-subtext -->
                    </div>
                    <!-- /.vabout-item -->
                    <div class="vabout-item">
                        ...
                        <!-- /.vabout-subtitle -->
                        <div class="vabout-subtext">Ekaterina</div>
                        <!-- /.vabout-subtext -->
                    </div>
                    <!-- /.vabout-item -->
                    <div class="vabout-item">
                        ...
                        <!-- /.vabout-subtitle -->
                        <div class="vabout-subtext">Танкер</div>
                        <!-- /.vabout-subtext -->
                    </div>
                    <!-- /.vabout-item -->
                </div>
        ...
        <aside class="vabout-aside">
            <div class="vabout-aside-top">
                <img src="assets/img/vabout/aside-img.png" alt="image" class="vabout-aside-img">
                <div class="vabout-aside-title">Koma Shipping Service Ltd.</div>
                <!-- /.vabout-aside-title -->
            </div>
            <!-- /.vabout-aside-top -->
...
в избранное
            ...
            <div class="vabout-aside-end">
                <a href="#" class="vabout-aside-link">Все вакансии компании (4)</a>
                <!-- /.vabout-aside-link -->
                <a href="#" class="vabout-aside-link">Добавить компанию в избранное</a>
                <!-- /.vabout-aside-link -->
            </div>
            <!-- /.vabout-aside-end -->
        </aside>
